...
public class RoomSpawner : MonoBehaviour
{
    ...
    void Spawn()
    {
        if (spawned == false)
        {
            ...
            {
                // Need to spawn a room with a TOP door (so it connects to the bottom of the previous room)
    ...
    //         {
    //             // The other spawn point already spawned a room here, so destroy this one
    //             Destroy(gameObject);
    //         }
    //     }
    // }
